...
import { DialogHeaderButton, DialogHeaderButtonSpec, DialogHeaderMenuButton, DialogHeaderNormalButton } from '../components/dialog/DialogHeaderButton';
...
export {
  ...
  DialogHeaderButton,
  DialogHeaderButtonSpec,
  DialogHeaderNormalButton,
  DialogHeaderMenuButton,
